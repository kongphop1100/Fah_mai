...
from fahmai.agents.tools.calculator import calculator_tool
...
ALL_TOOLS = [sql_query_tool, query_docs_tool, count_docs_tool, get_document_tool, calculator_tool]

__all__ = ["sql_query_tool", "query_docs_tool", "count_docs_tool", "search_docs_tool",
           "get_document_tool", "calculator_tool", "ALL_TOOLS"]
